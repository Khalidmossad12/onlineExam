...
export default function Signin() {
  return (
    <div className="login grid grid-cols-1 md:grid-cols-3 gap-8 space-y-10 h-screen">
  <div className="wlcome-elevate hidden md:flex h-full flex-col justify-center bg-[#F0F4FC] col-span-1 py-8 px-8 shadow-lg rounded-tr-[100px] rounded-br-[100px]">
